// ======================================================================
// CY8CKIT59_Ardudino-Speeduino.v generated from TopDesign.cysch
// 01/23/2018 at 21:39
...
// ADC_SAR_v3_0(ADC_Clock=1, ADC_Clock_Frequency=12800000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=1, ADC_Resolution=10, ADC_SampleMode=1, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=6, Sample_Rate=800000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC, CY_INSTANCE_SHORT_NAME=ADC, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=ADC, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=4294967295, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=4294967295, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=32, RunMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC32, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Millis_Counter, CY_INSTANCE_SHORT_NAME=Millis_Counter, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=Millis_Counter, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=0, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=4294967295, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=4294967295, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=32, RunMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC32, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Micros_Counter, CY_INSTANCE_SHORT_NAME=Micros_Counter, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=Micros_Counter, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=3, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=1, CONTROL3=1, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InitCounterValue=1000, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=1000, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Counter_1ms, CY_INSTANCE_SHORT_NAME=Counter_1ms, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=Counter_1ms, )
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=32000, CompareValue2=15000, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=45000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=1, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=true, TriggerMode=1, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IgnitionTimer_1, CY_INSTANCE_SHORT_NAME=IgnitionTimer_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=IgnitionTimer_1, )
module PWM_v3_30_7 (
    reset,
    clock,
    tc,
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=32000, CompareValue2=15000, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=45000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=1, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=true, TriggerMode=1, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=InjectionTimer_1, CY_INSTANCE_SHORT_NAME=InjectionTimer_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=InjectionTimer_1, )
module PWM_v3_30_8 (
    reset,
    clock,
    tc,
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=32000, CompareValue2=15000, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=45000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=1, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=true, TriggerMode=1, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=InjectionTimer_2, CY_INSTANCE_SHORT_NAME=InjectionTimer_2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=InjectionTimer_2, )
module PWM_v3_30_11 (
    reset,
    clock,
    tc,
...
module top ;
    ...
    defparam ADC_Mux.muxin_width = 8;
    defparam ADC_Mux.init_mux_sel = 8'h0;
    defparam ADC_Mux.one_active = 1;
    defparam ADC_Mux.connect_mode = 2;
	...
	wire [5:0] tmpOE__DB_net;
	wire [5:0] tmpFB_5__DB_net;
	wire [5:0] tmpIO_5__DB_net;
	wire [0:0] tmpINTERRUPT_0__DB_net;
	electrical [0:0] tmpSIOVREF__DB_net;
	...
	cy_psoc3_pins_v1_10
		...
		DB
		 (.oe(tmpOE__DB_net),
		  .y({6'b0}),
		  .fb({tmpFB_5__DB_net[5:0]}),
		  .io({tmpIO_5__DB_net[5:0]}),
		  .siovref(tmpSIOVREF__DB_net),
		  .interrupt({tmpINTERRUPT_0__DB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{6'b111111} : {6'b111111};
    ...
    Counter_v3_0_2 Millis_Counter (
        ...
        .up_ndown(1'b1),
        .count(Net_1767));
    defparam Millis_Counter.CaptureMode = 0;
    defparam Millis_Counter.ClockMode = 0;
    defparam Millis_Counter.CompareMode = 1;
    defparam Millis_Counter.CompareStatusEdgeSense = 1;
    defparam Millis_Counter.EnableMode = 0;
    defparam Millis_Counter.ReloadOnCapture = 0;
    defparam Millis_Counter.ReloadOnCompare = 0;
    defparam Millis_Counter.ReloadOnOverUnder = 1;
    defparam Millis_Counter.ReloadOnReset = 1;
    defparam Millis_Counter.Resolution = 32;
    defparam Millis_Counter.RunMode = 0;
    defparam Millis_Counter.UseInterrupt = 1;

    Counter_v3_0_3 Micros_Counter (
        .reset(1'b0),
        .tc(Net_4755),
        .comp(Net_4756),
        .clock(Net_2418),
        ...
        .up_ndown(1'b1),
        .count(Net_1766));
    defparam Micros_Counter.CaptureMode = 0;
    defparam Micros_Counter.ClockMode = 0;
    defparam Micros_Counter.CompareMode = 0;
    defparam Micros_Counter.CompareStatusEdgeSense = 1;
    defparam Micros_Counter.EnableMode = 0;
    defparam Micros_Counter.ReloadOnCapture = 0;
    defparam Micros_Counter.ReloadOnCompare = 0;
    defparam Micros_Counter.ReloadOnOverUnder = 1;
    defparam Micros_Counter.ReloadOnReset = 1;
    defparam Micros_Counter.Resolution = 32;
    defparam Micros_Counter.RunMode = 0;
    defparam Micros_Counter.UseInterrupt = 1;

    USBFS_v3_0_4 USBUART (
        .sof(Net_4178),
        .vbusdet(1'b0));
	...
	wire [7:0] tmpOE__P3_net;
	wire [7:0] tmpFB_7__P3_net;
	wire [7:0] tmpIO_7__P3_net;
	wire [0:0] tmpINTERRUPT_0__P3_net;
	electrical [0:0] tmpSIOVREF__P3_net;

	cy_psoc3_pins_v1_10
		#(.id("7cd4b659-c00a-4b03-93c8-a6aacce85dee"),
		  .drive_mode(24'b001_001_001_001_110_110_110_110),
		  ...
		  .output_conn(8'b0_0_0_0_1_1_1_1),
		...
		P3
		 (.oe(tmpOE__P3_net),
		  .y({P3_7, P3_6, P3_5, P3_4, 4'b0}),
		  .fb({tmpFB_7__P3_net[7:0]}),
		  .io({tmpIO_7__P3_net[7:0]}),
	...
	assign tmpOE__P3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};

	wire [5:0] tmpOE__P12_net;
	wire [5:0] tmpFB_5__P12_net;
	wire [3:0] tmpIO_5__P12_net;
	wire [0:0] tmpINTERRUPT_0__P12_net;
	electrical [0:0] tmpSIOVREF__P12_net;

	cy_psoc3_pins_v1_10
		#(.id("54ddad5e-b383-4d27-94d1-1487ef26739b"),
		  .drive_mode(18'b100_100_110_110_110_110),
		  .ibuf_enabled(6'b1_1_1_1_1_1),
		  .init_dr_st(6'b1_1_0_0_1_1),
		  .input_clk_en(0),
		  .input_sync(6'b1_1_1_1_1_1),
		  .input_sync_mode(6'b0_0_0_0_0_0),
		  .intr_mode(12'b00_00_00_00_00_00),
		...
		P12
		 (.oe(tmpOE__P12_net),
		  .y({6'b0}),
		  .fb({tmpFB_5__P12_net[5:0]}),
		  .io({tmpIO_5__P12_net[3:0], Net_7569, Net_7572}),
		  .siovref(tmpSIOVREF__P12_net),
		  .interrupt({tmpINTERRUPT_0__P12_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P12_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{6'b111111} : {6'b111111};

    Counter_v3_0_5 Counter_1ms (
        .reset(1'b0),
        .tc(Net_7407),
        .comp(Net_7409),
        .clock(CLK_1M),
        ...
        .up_ndown(1'b1),
        .count(1'b0));
    defparam Counter_1ms.CaptureMode = 0;
    defparam Counter_1ms.ClockMode = 3;
    defparam Counter_1ms.CompareMode = 1;
    defparam Counter_1ms.CompareStatusEdgeSense = 1;
    defparam Counter_1ms.EnableMode = 0;
    defparam Counter_1ms.ReloadOnCapture = 0;
    defparam Counter_1ms.ReloadOnCompare = 0;
    defparam Counter_1ms.ReloadOnOverUnder = 1;
    defparam Counter_1ms.ReloadOnReset = 1;
    defparam Counter_1ms.Resolution = 16;
    defparam Counter_1ms.RunMode = 0;
    defparam Counter_1ms.UseInterrupt = 1;
	...
	wire [7:0] tmpOE__P0_net;
	wire [7:0] tmpFB_7__P0_net;
	wire [7:0] tmpIO_7__P0_net;
	wire [0:0] tmpINTERRUPT_0__P0_net;
	electrical [0:0] tmpSIOVREF__P0_net;

	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  .drive_mode(24'b000_000_000_000_000_000_000_000),
		  .ibuf_enabled(8'b0_0_0_0_0_0_0_0),
		  .init_dr_st(8'b0_0_0_0_0_0_0_0),
		  .input_clk_en(0),
		  .input_sync(8'b1_1_1_1_1_1_1_1),
		  .input_sync_mode(8'b0_0_0_0_0_0_0_0),
		...
		P0
		 (.oe(tmpOE__P0_net),
		  .y({8'b0}),
		  .fb({tmpFB_7__P0_net[7:0]}),
		  .analog({Net_4450, Net_4451, Net_4452, Net_4449, Net_4448, Net_9999, Net_4446, Net_9997}),
		  .io({tmpIO_7__P0_net[7:0]}),
	...
	assign tmpOE__P0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};

	wire [7:0] tmpOE__P2_net;
	wire [4:0] tmpFB_7__P2_net;
	wire [0:0] tmpFB_1__P2_net;
	wire [7:0] tmpIO_7__P2_net;
	electrical [0:0] tmpSIOVREF__P2_net;

	cy_psoc3_pins_v1_10
		#(.id("c29ca281-ba38-4f0d-bbbd-0d147e21df43"),
		  .drive_mode(24'b001_110_010_001_110_110_110_110),
		  .ibuf_enabled(8'b1_1_1_1_1_1_1_1),
		  .init_dr_st(8'b0_0_1_0_0_0_0_0),
		  .input_clk_en(0),
		  .input_sync(8'b1_1_1_1_1_1_1_1),
		  .input_sync_mode(8'b0_0_0_0_0_0_0_0),
		  .intr_mode(16'b01_00_00_01_00_00_00_00),
		  .invert_in_clock(0),
		  .invert_in_clock_en(0),
		  .invert_in_reset(0),
		  .invert_out_clock(0),
		  ...
		  .spanning(0),
		  .use_annotation(8'b0_0_0_0_0_0_0_0),
		  .vtrip(16'b00_10_00_00_00_00_00_00),
		  .width(8),
		  .ovt_hyst_trim(8'b0_0_0_0_0_0_0_0),
		  .ovt_needed(8'b0_0_0_0_0_0_0_0),
		  .ovt_slew_control(16'b00_00_00_00_00_00_00_00),
		...
		P2
		 (.oe(tmpOE__P2_net),
		  .y({P2_7, P2_6, P2_5, P2_4, 4'b0}),
		  .fb({tmpFB_7__P2_net[4:0], userButton, tmpFB_1__P2_net[0:0], P2_0}),
    ...
    Timer_v2_70_6 BootloaderResetTimer (
        .reset(Net_3288),
        .interrupt(Net_4829),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_4833),
        .tc(Net_3478),
        .clock(Net_3286));
    defparam BootloaderResetTimer.CaptureCount = 2;
    defparam BootloaderResetTimer.CaptureCounterEnabled = 0;
    defparam BootloaderResetTimer.DeviceFamily = "PSoC5";
    defparam BootloaderResetTimer.InterruptOnCapture = 0;
    defparam BootloaderResetTimer.InterruptOnTC = 0;
    defparam BootloaderResetTimer.Resolution = 16;
    defparam BootloaderResetTimer.SiliconRevision = "0";
    ...
    PWM_v3_30_7 IgnitionTimer_1 (
        ...
        .ph1(Net_11123),
        .ph2(Net_11124));
    defparam IgnitionTimer_1.Resolution = 16;
    ...
    // -- De Mux start --
    if (1)
    begin : Ignition_demux
        reg  tmp__Ignition_demux_0_reg;
        reg  tmp__Ignition_demux_1_reg;
        reg  tmp__Ignition_demux_2_reg;
        reg  tmp__Ignition_demux_3_reg;
        always @(Net_7515 or Net_10047)
        begin
            case (Net_10047[1:0])
                2'b00:
                begin
                    tmp__Ignition_demux_0_reg = Net_7515;
                    tmp__Ignition_demux_1_reg = 1'b0;
                    tmp__Ignition_demux_2_reg = 1'b0;
                    tmp__Ignition_demux_3_reg = 1'b0;
                end
                2'b01:
                begin
                    tmp__Ignition_demux_0_reg = 1'b0;
                    tmp__Ignition_demux_1_reg = Net_7515;
                    tmp__Ignition_demux_2_reg = 1'b0;
                    tmp__Ignition_demux_3_reg = 1'b0;
                end
                2'b10:
                begin
                    tmp__Ignition_demux_0_reg = 1'b0;
                    tmp__Ignition_demux_1_reg = 1'b0;
                    tmp__Ignition_demux_2_reg = Net_7515;
                    tmp__Ignition_demux_3_reg = 1'b0;
                end
                2'b11:
                begin
                    ...
                    tmp__Ignition_demux_1_reg = 1'b0;
                    tmp__Ignition_demux_2_reg = 1'b0;
                    tmp__Ignition_demux_3_reg = Net_7515;
                end
            endcase
        end
        assign P2_4 = tmp__Ignition_demux_0_reg;
        assign P2_5 = tmp__Ignition_demux_1_reg;
        assign P2_6 = tmp__Ignition_demux_2_reg;
        assign P2_7 = tmp__Ignition_demux_3_reg;
    end
    // -- De Mux end --

    CyControlReg_v1_80 InjectionTimerPortControlReg_1 (
        .control_1(Net_10409),
        .control_2(Net_10410),
        .control_3(Net_10411),
        .control_0(Net_10412),
        ...
        .clock(1'b0),
        .reset(1'b0),
        .control_bus(Net_10048[1:0]));
    defparam InjectionTimerPortControlReg_1.Bit0Mode = 0;
    defparam InjectionTimerPortControlReg_1.Bit1Mode = 0;
    defparam InjectionTimerPortControlReg_1.Bit2Mode = 0;
    defparam InjectionTimerPortControlReg_1.Bit3Mode = 0;
    defparam InjectionTimerPortControlReg_1.Bit4Mode = 0;
    defparam InjectionTimerPortControlReg_1.Bit5Mode = 0;
    defparam InjectionTimerPortControlReg_1.Bit6Mode = 0;
    defparam InjectionTimerPortControlReg_1.Bit7Mode = 0;
    defparam InjectionTimerPortControlReg_1.BitValue = 0;
    defparam InjectionTimerPortControlReg_1.BusDisplay = 1;
    defparam InjectionTimerPortControlReg_1.ExtrReset = 0;
    defparam InjectionTimerPortControlReg_1.NumOutputs = 2;

    PWM_v3_30_8 InjectionTimer_1 (
        .reset(Net_11136),
        .clock(CLK_1M),
        .tc(Net_11136),
        .pwm1(Net_11126),
        ...
        .ph1(Net_11133),
        .ph2(Net_11134));
    defparam InjectionTimer_1.Resolution = 16;

    CyControlReg_v1_80 IgnitionPortControlReg (
        .control_1(Net_10399),
        .control_2(Net_10400),
        .control_3(Net_10401),
        .control_0(Net_10402),
        ...
        .clock(1'b0),
        .reset(1'b0),
        .control_bus(Net_10047[1:0]));
    defparam IgnitionPortControlReg.Bit0Mode = 0;
    defparam IgnitionPortControlReg.Bit1Mode = 0;
    defparam IgnitionPortControlReg.Bit2Mode = 0;
    defparam IgnitionPortControlReg.Bit3Mode = 0;
    defparam IgnitionPortControlReg.Bit4Mode = 0;
    defparam IgnitionPortControlReg.Bit5Mode = 0;
    defparam IgnitionPortControlReg.Bit6Mode = 0;
    defparam IgnitionPortControlReg.Bit7Mode = 0;
    defparam IgnitionPortControlReg.BitValue = 0;
    defparam IgnitionPortControlReg.BusDisplay = 1;
    defparam IgnitionPortControlReg.ExtrReset = 0;
    defparam IgnitionPortControlReg.NumOutputs = 2;

    // -- De Mux start --
    if (1)
    begin : Injection_demux
        reg  tmp__Injection_demux_0_reg;
        reg  tmp__Injection_demux_1_reg;
        reg  tmp__Injection_demux_2_reg;
        reg  tmp__Injection_demux_3_reg;
        always @(Net_7509 or Net_10048)
        begin
            case (Net_10048[1:0])
                2'b00:
                begin
                    tmp__Injection_demux_0_reg = Net_7509;
                    tmp__Injection_demux_1_reg = 1'b0;
                    tmp__Injection_demux_2_reg = 1'b0;
                    tmp__Injection_demux_3_reg = 1'b0;
                end
                2'b01:
                begin
                    tmp__Injection_demux_0_reg = 1'b0;
                    tmp__Injection_demux_1_reg = Net_7509;
                    tmp__Injection_demux_2_reg = 1'b0;
                    tmp__Injection_demux_3_reg = 1'b0;
                end
                2'b10:
                begin
                    tmp__Injection_demux_0_reg = 1'b0;
                    tmp__Injection_demux_1_reg = 1'b0;
                    tmp__Injection_demux_2_reg = Net_7509;
                    tmp__Injection_demux_3_reg = 1'b0;
                end
                2'b11:
                begin
                    ...
                    tmp__Injection_demux_1_reg = 1'b0;
                    tmp__Injection_demux_2_reg = 1'b0;
                    tmp__Injection_demux_3_reg = Net_7509;
                end
            endcase
        end
        assign Net_11174 = tmp__Injection_demux_0_reg;
        assign Net_11170 = tmp__Injection_demux_1_reg;
        assign Net_11167 = tmp__Injection_demux_2_reg;
        assign Net_11164 = tmp__Injection_demux_3_reg;
    end
    // -- De Mux end --
	...
	cy_isr_v1_0
		...
		CrankTriggerDummyTimer_isr
		 (.int_signal(Net_13563));


    PulseConvert_v1_0 PulseConvert_1 (
        .p_in(P2_0),
        .p_out(Net_13575),
        .sample_clk(Net_13595),
        .out_clk(Net_13595));

    Timer_v2_70_10 CrankTriggerDummyTimer (
        .reset(Net_13545),
        .interrupt(Net_13563),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_11868),
        .tc(Net_13547),
        .clock(Net_13573));
    defparam CrankTriggerDummyTimer.CaptureCount = 2;
    defparam CrankTriggerDummyTimer.CaptureCounterEnabled = 0;
    defparam CrankTriggerDummyTimer.DeviceFamily = "PSoC5";
    defparam CrankTriggerDummyTimer.InterruptOnCapture = 0;
    defparam CrankTriggerDummyTimer.InterruptOnTC = 1;
    defparam CrankTriggerDummyTimer.Resolution = 16;
    defparam CrankTriggerDummyTimer.SiliconRevision = "0";

    CyControlReg_v1_80 InjectionTimerControlReg_1 (
        .control_1(Net_10388),
        .control_2(Net_10389),
        .control_3(Net_10390),
        .control_0(Net_10042),
        ...
        .clock(Net_10395),
        .reset(Net_11136));
    defparam InjectionTimerControlReg_1.Bit0Mode = 1;
    defparam InjectionTimerControlReg_1.Bit1Mode = 0;
    defparam InjectionTimerControlReg_1.Bit2Mode = 0;
    defparam InjectionTimerControlReg_1.Bit3Mode = 0;
    defparam InjectionTimerControlReg_1.Bit4Mode = 0;
    defparam InjectionTimerControlReg_1.Bit5Mode = 0;
    defparam InjectionTimerControlReg_1.Bit6Mode = 0;
    defparam InjectionTimerControlReg_1.Bit7Mode = 0;
    defparam InjectionTimerControlReg_1.BitValue = 0;
    defparam InjectionTimerControlReg_1.BusDisplay = 0;
    defparam InjectionTimerControlReg_1.ExtrReset = 1;
    defparam InjectionTimerControlReg_1.NumOutputs = 1;

    CyControlReg_v1_80 IgnitionTimerControlReg (
        .control_1(Net_10379),
        .control_2(Net_10380),
        .control_3(Net_10381),
        .control_0(Net_10045),
        ...
        .clock(Net_10386),
        .reset(Net_10602));
    defparam IgnitionTimerControlReg.Bit0Mode = 1;
    defparam IgnitionTimerControlReg.Bit1Mode = 0;
    defparam IgnitionTimerControlReg.Bit2Mode = 0;
    defparam IgnitionTimerControlReg.Bit3Mode = 0;
    defparam IgnitionTimerControlReg.Bit4Mode = 0;
    defparam IgnitionTimerControlReg.Bit5Mode = 0;
    defparam IgnitionTimerControlReg.Bit6Mode = 0;
    defparam IgnitionTimerControlReg.Bit7Mode = 0;
    defparam IgnitionTimerControlReg.BitValue = 0;
    defparam IgnitionTimerControlReg.BusDisplay = 0;
    defparam IgnitionTimerControlReg.ExtrReset = 1;
    defparam IgnitionTimerControlReg.NumOutputs = 1;


    assign Net_4973 = Net_10397 & Net_10042;


    assign Net_5006 = Net_10397 & Net_10045;
    ...
    assign P3_7 = Net_11163 | Net_11164;


    assign P3_6 = Net_11166 | Net_11167;


    assign P3_5 = Net_11169 | Net_11170;


    assign P3_4 = Net_11173 | Net_11174;

    PWM_v3_30_11 InjectionTimer_2 (
        .reset(Net_11179),
        .clock(CLK_1M),
        .tc(Net_11179),
        .pwm1(Net_13295),
        ...
        .ph1(Net_13302),
        .ph2(Net_13303));
    defparam InjectionTimer_2.Resolution = 16;

    // -- De Mux start --
    if (1)
    begin : Injection_demux_1
        reg  tmp__Injection_demux_1_0_reg;
        reg  tmp__Injection_demux_1_1_reg;
        reg  tmp__Injection_demux_1_2_reg;
        reg  tmp__Injection_demux_1_3_reg;
        always @(Net_11188 or Net_11195)
        begin
            case (Net_11195[1:0])
                2'b00:
                begin
                    tmp__Injection_demux_1_0_reg = Net_11188;
                    tmp__Injection_demux_1_1_reg = 1'b0;
                    tmp__Injection_demux_1_2_reg = 1'b0;
                    tmp__Injection_demux_1_3_reg = 1'b0;
                end
                2'b01:
                begin
                    tmp__Injection_demux_1_0_reg = 1'b0;
                    tmp__Injection_demux_1_1_reg = Net_11188;
                    tmp__Injection_demux_1_2_reg = 1'b0;
                    tmp__Injection_demux_1_3_reg = 1'b0;
                end
                2'b10:
                begin
                    tmp__Injection_demux_1_0_reg = 1'b0;
                    tmp__Injection_demux_1_1_reg = 1'b0;
                    tmp__Injection_demux_1_2_reg = Net_11188;
                    tmp__Injection_demux_1_3_reg = 1'b0;
                end
                2'b11:
                begin
                    ...
                    tmp__Injection_demux_1_1_reg = 1'b0;
                    tmp__Injection_demux_1_2_reg = 1'b0;
                    tmp__Injection_demux_1_3_reg = Net_11188;
                end
            endcase
        end
        assign Net_11173 = tmp__Injection_demux_1_0_reg;
        assign Net_11169 = tmp__Injection_demux_1_1_reg;
        assign Net_11166 = tmp__Injection_demux_1_2_reg;
        assign Net_11163 = tmp__Injection_demux_1_3_reg;
    end
    // -- De Mux end --

    CyControlReg_v1_80 InjectionTimerPortControlReg_2 (
        .control_1(Net_11196),
        .control_2(Net_11197),
        .control_3(Net_11198),
        .control_0(Net_11199),
        ...
        .clock(1'b0),
        .reset(1'b0),
        .control_bus(Net_11195[1:0]));
    defparam InjectionTimerPortControlReg_2.Bit0Mode = 0;
    defparam InjectionTimerPortControlReg_2.Bit1Mode = 0;
    defparam InjectionTimerPortControlReg_2.Bit2Mode = 0;
    defparam InjectionTimerPortControlReg_2.Bit3Mode = 0;
    defparam InjectionTimerPortControlReg_2.Bit4Mode = 0;
    defparam InjectionTimerPortControlReg_2.Bit5Mode = 0;
    defparam InjectionTimerPortControlReg_2.Bit6Mode = 0;
    defparam InjectionTimerPortControlReg_2.Bit7Mode = 0;
    defparam InjectionTimerPortControlReg_2.BitValue = 0;
    defparam InjectionTimerPortControlReg_2.BusDisplay = 1;
    defparam InjectionTimerPortControlReg_2.ExtrReset = 0;
    defparam InjectionTimerPortControlReg_2.NumOutputs = 2;

    CyControlReg_v1_80 InjectionTimerControlReg_2 (
        .control_1(Net_11206),
        .control_2(Net_11207),
        .control_3(Net_11208),
        .control_0(Net_11209),
        ...
        .clock(Net_11214),
        .reset(Net_11179));
    defparam InjectionTimerControlReg_2.Bit0Mode = 1;
    defparam InjectionTimerControlReg_2.Bit1Mode = 0;
    defparam InjectionTimerControlReg_2.Bit2Mode = 0;
    defparam InjectionTimerControlReg_2.Bit3Mode = 0;
    defparam InjectionTimerControlReg_2.Bit4Mode = 0;
    defparam InjectionTimerControlReg_2.Bit5Mode = 0;
    defparam InjectionTimerControlReg_2.Bit6Mode = 0;
    defparam InjectionTimerControlReg_2.Bit7Mode = 0;
    defparam InjectionTimerControlReg_2.BitValue = 0;
    defparam InjectionTimerControlReg_2.BusDisplay = 0;
    defparam InjectionTimerControlReg_2.ExtrReset = 1;
    defparam InjectionTimerControlReg_2.NumOutputs = 1;


    assign Net_11530 = Net_10397 & Net_11209;
    ...
    CyControlReg_v1_80 CrankTriggerDummyTimerReg (
        .control_1(Net_13312),
        .control_2(Net_11829),
        .control_3(Net_11830),
        .control_0(Net_13545),
        ...
        .clock(Net_13573),
        .reset(1'b0));
    defparam CrankTriggerDummyTimerReg.Bit0Mode = 3;
    defparam CrankTriggerDummyTimerReg.Bit1Mode = 0;
    defparam CrankTriggerDummyTimerReg.Bit2Mode = 0;
    defparam CrankTriggerDummyTimerReg.Bit3Mode = 0;
    defparam CrankTriggerDummyTimerReg.Bit4Mode = 0;
    defparam CrankTriggerDummyTimerReg.Bit5Mode = 0;
    defparam CrankTriggerDummyTimerReg.Bit6Mode = 0;
    defparam CrankTriggerDummyTimerReg.Bit7Mode = 0;
    defparam CrankTriggerDummyTimerReg.BitValue = 0;
    defparam CrankTriggerDummyTimerReg.BusDisplay = 0;
    defparam CrankTriggerDummyTimerReg.ExtrReset = 1;
    defparam CrankTriggerDummyTimerReg.NumOutputs = 1;


    assign Net_10397 = Net_13547 | Net_13575;
