...
*
* \funcusage
*  \snippet P15_5_SUT.c usage_P15_5_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet P15_5_SUT.c usage_P15_5_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet P15_5_SUT.c usage_P15_5_Read  
*******************************************************************************/
...
* preferred P15_5_Read() API because the 
* P15_5_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet P15_5_SUT.c usage_P15_5_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: P15_5_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use P15_5_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - P15_5_0_INTR       (First pin in the list)
    *  - P15_5_1_INTR       (Second pin in the list)
    *  - ...
    *  - P15_5_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet P15_5_SUT.c usage_P15_5_SetInterruptMode
    *******************************************************************************/
    void P15_5_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & P15_5_0_INTR) != 0u) 
		{ 
			 P15_5_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet P15_5_SUT.c usage_P15_5_ClearInterrupt
    *******************************************************************************/
