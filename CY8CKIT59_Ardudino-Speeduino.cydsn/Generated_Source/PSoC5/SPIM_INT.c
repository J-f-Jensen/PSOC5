...
CY_ISR(SPIM_TX_ISR)
{
    ...
    #ifdef SPIM_TX_ISR_ENTRY_CALLBACK
        SPIM_TX_ISR_EntryCallback();
    #endif /* SPIM_TX_ISR_ENTRY_CALLBACK */
    ...
    #ifdef SPIM_TX_ISR_EXIT_CALLBACK
        SPIM_TX_ISR_ExitCallback();
    #endif /* SPIM_TX_ISR_EXIT_CALLBACK */
}
...
CY_ISR(SPIM_RX_ISR)
{
    ...
    #endif /* SPIM_RX_ISR_ENTRY_CALLBACK */
    ...
    #ifdef SPIM_RX_ISR_EXIT_CALLBACK
        SPIM_RX_ISR_ExitCallback();
    #endif /* SPIM_RX_ISR_EXIT_CALLBACK */
}
