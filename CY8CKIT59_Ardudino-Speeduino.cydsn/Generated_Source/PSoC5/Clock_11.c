...
void Clock_11_Start(void) 
{
    ...
    Clock_11_CLKEN |= Clock_11_CLKEN_MASK;
	Clock_11_CLKSTBY |= Clock_11_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: Clock_11_Stop
********************************************************************************
*
* Summary:
...
void Clock_11_Stop(void) 
{
    ...
    Clock_11_CLKEN &= (uint8)(~Clock_11_CLKEN_MASK);
	Clock_11_CLKSTBY &= (uint8)(~Clock_11_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: Clock_11_StopBlock
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_11_StopBlock(void) 
{
    if ((Clock_11_CLKEN & Clock_11_CLKEN_MASK) != 0u)
    {
...
#if defined(Clock_11__CFG3)
        CLK_DIST_AMASK = Clock_11_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = Clock_11_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* Clock_11__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(Clock_11_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(Clock_11_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: Clock_11_StandbyPower
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_11_StandbyPower(uint8 state) 
{
    if(state == 0u)
    {
        Clock_11_CLKSTBY &= (uint8)(~Clock_11_CLKSTBY_MASK);
...
/*******************************************************************************
* Function Name: Clock_11_SetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_11_SetDividerRegister(uint16 clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = Clock_11_GetSourceRegister();
    uint16 oldDivider = Clock_11_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = Clock_11_CLKEN & Clock_11_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((Clock_11_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: Clock_11_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(Clock_11_DIV_PTR);
}


/*******************************************************************************
* Function Name: Clock_11_SetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_11_SetModeRegister(uint8 modeBitMask) 
{
    Clock_11_MOD_SRC |= modeBitMask & (uint8)Clock_11_MODE_MASK;
}


/*******************************************************************************
* Function Name: Clock_11_ClearModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_11_ClearModeRegister(uint8 modeBitMask) 
{
    Clock_11_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(Clock_11_MODE_MASK));
}


/*******************************************************************************
* Function Name: Clock_11_GetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Clock_11_GetModeRegister(void) 
{
    return Clock_11_MOD_SRC & (uint8)(Clock_11_MODE_MASK);
}


/*******************************************************************************
* Function Name: Clock_11_SetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_11_SetSourceRegister(uint8 clkSource) 
{
    uint16 currDiv = Clock_11_GetDividerRegister();
    uint8 oldSrc = Clock_11_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        Clock_11_MOD_SRC |= CYCLK_SSS;
        Clock_11_MOD_SRC =
            (Clock_11_MOD_SRC & (uint8)(~Clock_11_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: Clock_11_GetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Clock_11_GetSourceRegister(void) 
{
    return Clock_11_MOD_SRC & Clock_11_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: Clock_11_SetPhaseRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_11_SetPhaseRegister(uint8 clkPhase) 
{
    Clock_11_PHASE = clkPhase & Clock_11_PHASE_MASK;
}


/*******************************************************************************
* Function Name: Clock_11_GetPhase
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Clock_11_GetPhaseRegister(void) 
{
    return Clock_11_PHASE & Clock_11_PHASE_MASK;
}
